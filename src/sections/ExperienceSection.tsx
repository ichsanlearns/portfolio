                ...
                >
                  ...
                  <div className="xl:w-4/6">
                    <div className="flex items-start relative">
                      <div className="absolute top-0 left-5 h-full flex justify-center md:left-10 xl:left-[2vw]">
                        <div className="timeline absolute z-30 h-[110%] -top-20 w-14 bg-black md:w-28" />
